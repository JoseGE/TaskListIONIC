...
var ListaDeseosProvider = (function () {
    function ListaDeseosProvider(http) {
        this.http = http;
        this.listas = [];
        this.loadStorage();
    ...
    ListaDeseosProvider.prototype.updateStorage = function () {
        console.log(this.listas);
        localStorage.setItem("data", JSON.stringify(this.listas));
    };
    ListaDeseosProvider.prototype.loadStorage = function () {
        if (localStorage.getItem("data"))
            this.listas = JSON.parse(localStorage.getItem("data"));
    };
    ListaDeseosProvider.prototype.addList = function (list) {
        this.updateStorage();
    };
    ListaDeseosProvider.prototype.deleteList = function (idx) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_lista_deseos_lista_deseos__ = __webpack_require__(198);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_6__providers_lista_deseos_lista_deseos__["a" /* ListaDeseosProvider */]
            ]
        })
    ], AppModule);
    return AppModule;
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"E:\programacion\Angular\deseosapp\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"E:\programacion\Angular\deseosapp\src\app\app.html"*/
        }),
